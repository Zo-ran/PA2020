...
instr_func group_1_b_entry[8] =
    {add_i2rm_b, or_i2rm_b, adc_i2rm_b, inv, and_i2rm_b, sub_i2rm_b, xor_i2rm_b, inv};

/* 0x81 */
instr_func group_1_v_entry[8] =
    {add_i2rm_v, or_i2rm_v, adc_i2rm_v, inv, and_i2rm_v, sub_i2rm_v, xor_i2rm_b, inv};

/* 0x83 */
instr_func group_1_bv_entry[8] =
    {add_i2rm_bv, or_i2rm_bv, add_i2rm_bv, inv, and_i2rm_bv, sub_i2rm_bv, xor_i2rm_b, cmp_i2rm_bv};
